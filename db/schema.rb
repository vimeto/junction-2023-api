...
ActiveRecord::Schema[7.1].define(version: 2023_11_11_094220) do
  ...
  create_table "heating_systems", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "queries", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "occupants"
    t.datetime "due_date"
    t.bigint "currentheating_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["address_id"], name: "index_queries_on_address_id"
    t.index ["currentheating_id"], name: "index_queries_on_currentheating_id"
  ...
  add_foreign_key "queries", "heatings", column: "currentheating_id"
